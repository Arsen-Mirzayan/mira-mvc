...
public class UrlUtils {
  /**
   * Удаляет из строки все символы, которые не являются буквой, числом, тире или подчёркиванием
   *
  ...
  public static String normalize(String source) {
    ...
    return source.toLowerCase().replaceAll("[^a-zA-Zа-яА-Я_ 0-9]", "").replaceAll("\\s+", "_").replaceAll("_+", "_").replaceAll("^_+", "").replaceAll("_+$", "");
  }

  /**
   * Кодирует строку в соотвествии с правилами url. Символы разделители пути / не кодируются.
   *
   * @param source исходная строка
